...
const translations :MenuTranslations = {
    ...
    
    {
        ...
        dishes: ["Webfoot Octopus Signature Set, 쭈꾸미 시그니처 세트", "Webfoot Octopus with Porck belly Signature Set, 쭈꾸미삼겹 시그니처 세트"],
        ...
        dishes2: ["Webfoot Octopus Set, 쭈꾸미 세트", "Webfoot Octopus-Samgyeop Set, 쭈꾸미삼겹 세트", "Grilled Set, 구이 세트"],
        ...
        discriptions2: [
            ...
            "Choose 2 (Salted Octopus / Octopus with Pork Belly (+₩2,000) / Spicy Octopus / Sea Eel (+₩1,000)) + Rice Cake + Steamed Egg (Add cheese for +₩1,500)"
        ],
        title33: "Additional Menu (단품 메뉴)",
        dishes33: ["Webfoot Octopus, 철판 쭈꾸미", "Webfoot Octopus with Pork Belly, 철판 쭈꾸미 삼겹살", "Salted Grilled Octopus, 소금구이", "Octopus & Pork Belly Grill, 쭈삼구이", "Spicy Grilled Octopus, 양념구이", "Grilled Sea Eel, 꼼장어구이"],
    ...
    ja: {
        ...
        discriptions4:[],
        title5: "酒類 / ソフトドリンク",
        dishes5: ["焼酎（チャミスル、初めてのように、ジンロ、セロ）, 소주(참이슬/ 처음처럼/ 진로/ 새로)", "清酒, 청하", "ハルラサン,한라산", "ビール（カス、テラ、ケリー、クラッシュ), 맥주(카스/ 테라/ 켈리/ 크러시)", "ノンアルコールビール（青島、ハイネケン, 논알콜 맥주(칭따오/ 하이네켄)", "ソフトドリンク（コーラ、サイダー、ゼロコーラ、ゼロサイダー）, 음료(콜라/ 사이다/ 제로콜라/ 제로사이다)", "ハイボール, 순정 하이볼", "情熱ハイボール, 열정 하이볼"],
        prices5: ["₩5,000", "₩6,000", "₩6,000", "₩5,000", "₩6,000/₩8,000", "₩2,000", "₩8,000", "₩8,000"],
        discriptions5:[],
    }
    ,
